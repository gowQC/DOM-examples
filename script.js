...
for (i = 0; i<parent_example.length; i++) { // basically, each li points to the SAME ul element - they all have the same parent
...
// Now we are console logging the elements we would expect to see. In conclusion, consider white spaces and texts when grabbing children from an element!
